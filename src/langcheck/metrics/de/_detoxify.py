...
def load_checkpoint(
    device: str
) -> Tuple[XLMRobertaForSequenceClassification, XLMRobertaTokenizer, List[str]]:
    checkpoint_url = "https://github.com/unitaryai/detoxify/releases/download/v0.4-alpha/multilingual_debiased-0b549669.ckpt"  # NOQA: E501
