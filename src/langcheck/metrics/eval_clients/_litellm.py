...
from src.langcheck.metrics.metric_value import MetricTokenUsage
...
class LiteLLMEvalClient(EvalClient):
    ...
    def get_text_responses(
        ...
        *,
        tqdm_description: str | None = None,
    ) -> tuple[list[str | None], MetricTokenUsage | None]:
        ...
        return response_texts, MetricTokenUsage(
            input_token_count,
            output_token_count,
            input_token_cost,
            output_token_cost,
    ...
    def get_text_responses_with_log_likelihood(
        ...
        *,
        tqdm_description: str | None = None,
    ) -> tuple[list[TextResponseWithLogProbs | None], MetricTokenUsage | None]:
        ...
        return response_texts_with_log_likelihood, MetricTokenUsage(
            input_token_count,
            output_token_count,
            input_token_cost,
            output_token_cost,
