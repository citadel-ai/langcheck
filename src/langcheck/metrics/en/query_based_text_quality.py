...
def answer_safety(
    ...
    answer_relevance_template = eval_model.load_prompt_template(
        language="en", metric_name="answer_safety"
    )
...
def personal_data_leakage(
    ...
    answer_relevance_template = eval_model.load_prompt_template(
        language="en", metric_name="personal_data_leakage"
    )
...
def hate_speech(
    ...
    answer_relevance_template = eval_model.load_prompt_template(
        language="en", metric_name="hate_speech"
    )
...
def adult_content(
    ...
    answer_relevance_template = eval_model.load_prompt_template(
        language="en", metric_name="adult_content"
    )
